class PurchaseAddress
  ...
  def save
    ...
    Address.create(postal_code: postal_code, shipping_area_id: shipping_area_id, city: city, home_number: home_number,tel: tel, building: building, purchase_id: purchase_address.id )
  end
end 